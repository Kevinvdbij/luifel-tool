...
export function getLuifelData() {
    return luifelData;
}

let manufacturerById: {[key: string]: string} = {
    "7ff317555f724164ad5eeceabaafc76b":"Fiamma",
    "b8d17e028fa5415da5abe473bce93bc5":"Thule"
};
...
export function getEanBySku(sku: string){
    return eanBySKU[sku];
}